...
const addTwo = (arr) => arr.map(n=>n+2);
...
const typeNum = (arr) => {
  let newArr=arr.filter(value=>(value/1));
  return newArr;
};
...
const containsAnd = (arr) => {
  let newArr=arr.filter((n)=>n.includes('and'));
  return newArr;
};
...
const oddValues = (arr) => arr.filter(i => i % 2);
...
const notInFirstArray = (val, arr) => arr.filter(i => !val.includes(i));
/* ------------------------------------------------------------------------------------------------
